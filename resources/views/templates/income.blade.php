...
<div class="navbar control-bar">
  <div class="container-fluid">
    ...
    <button type="button" class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#addIncomeModal">Thêm phiếu <i class="fas fa-plus-circle"></i></button>
  </div>
</div>
  ...
  <table class="table table-striped table-bordered align-middle">
    ...
    <tbody>
      <tr>
        ...
        <td scope="col">2.000.000 Đ</td>
        <td class="text-center" scope="col">Thu nợ</td>
        <td class="text-center" scope="col">
          <div class="btn-group btn-group-sm" role="group">
            <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#editIncomeModal"><i class="fas fa-pencil-alt"></i></button>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9">
              <select class="form-select">
                <option value="" disabled selected>Lựa chọn lý do</option>
