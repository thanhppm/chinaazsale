...
<div class="navbar control-bar">
  <div class="container-fluid  justify-content-end">
    ...
    <button type="button" class="btn btn-outline-success me-2" data-bs-toggle="modal" data-bs-target="#addOrderModal">Tạo đơn hàng <i class="fas fa-plus-circle"></i></button>
  </div>
</div>
  ...
  <table class="table table-striped table-bordered align-middle">
    <thead>
      <tr class="text-center align-middle">
        <th scope="col">Gom theo KH (Mã KH)</th>
